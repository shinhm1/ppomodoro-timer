...
import com.mini.project._1.ppomodoro.PpomodoroApplicationTests__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.mini.project._1.ppomodoro.PpomodoroApplicationTests", () -> new PpomodoroApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.mini.project._1.ppomodoro.PpomodoroApplicationTests", PpomodoroApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
