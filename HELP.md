...
* The original package name 'com.mini.project.01.ppomodoro' is invalid and this project uses 'com.mini.project._1.ppomodoro' instead.
...
```
$ docker run --rm -p 8080:8080 ppomodoro:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/ppomodoro
```
